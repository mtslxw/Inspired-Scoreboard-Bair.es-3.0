...
function UpdatePlayerTable(connectedPlayers)
	...
	local psg, police, ambulance, mechanic, cardealer, estate, players = 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs = {psg = psg, police = police, ambulance = ambulance, mechanic = mechanic, cardealer = cardealer, estate = estate, player_count = players}
	})
end
